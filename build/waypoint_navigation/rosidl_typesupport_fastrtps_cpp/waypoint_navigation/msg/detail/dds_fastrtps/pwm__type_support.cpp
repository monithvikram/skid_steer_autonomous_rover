...
#include "waypoint_navigation/msg/detail/pwm__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = waypoint_navigation::msg::Pwm;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const waypoint_navigation::msg::Pwm *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<waypoint_navigation::msg::Pwm *>(
    untyped_ros_message);
...
{
  return &waypoint_navigation::msg::typesupport_fastrtps_cpp::_Pwm__handle;
}
