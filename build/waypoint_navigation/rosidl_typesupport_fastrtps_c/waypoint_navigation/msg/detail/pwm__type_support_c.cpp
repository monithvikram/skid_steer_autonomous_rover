...
#include "waypoint_navigation/msg/detail/pwm__rosidl_typesupport_fastrtps_c.h"
...
using _Pwm__ros_msg_type = waypoint_navigation__msg__Pwm;
...
size_t get_serialized_size_waypoint_navigation__msg__Pwm(
  const void * untyped_ros_message,
...
static uint32_t _Pwm__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_waypoint_navigation__msg__Pwm(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_waypoint_navigation
size_t max_serialized_size_waypoint_navigation__msg__Pwm(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = waypoint_navigation__msg__Pwm;
    is_plain =
      (
      offsetof(DataType, pwm_r) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _Pwm__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_waypoint_navigation__msg__Pwm(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, waypoint_navigation, msg, Pwm)() {
