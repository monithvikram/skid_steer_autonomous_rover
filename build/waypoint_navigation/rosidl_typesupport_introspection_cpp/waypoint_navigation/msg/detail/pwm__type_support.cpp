...
{
  new (message_memory) waypoint_navigation::msg::Pwm(_init);
}

void Pwm_fini_function(void * message_memory)
{
  auto typed_message = static_cast<waypoint_navigation::msg::Pwm *>(message_memory);
  typed_message->~Pwm();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Pwm_message_member_array[2] = {
  {
    ...
    offsetof(waypoint_navigation::msg::Pwm, pwm_l),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(waypoint_navigation::msg::Pwm, pwm_r),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Pwm_message_members = {
  ...
  "Pwm",  // message name
  2,  // number of fields
  sizeof(waypoint_navigation::msg::Pwm),
...
get_message_type_support_handle<waypoint_navigation::msg::Pwm>()
{
  return &::waypoint_navigation::msg::rosidl_typesupport_introspection_cpp::Pwm_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, waypoint_navigation, msg, Pwm)() {
  return &::waypoint_navigation::msg::rosidl_typesupport_introspection_cpp::Pwm_message_type_support_handle;
}
