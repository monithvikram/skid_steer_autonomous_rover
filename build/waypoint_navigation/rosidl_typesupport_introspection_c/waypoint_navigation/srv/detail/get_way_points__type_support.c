...
#include <stddef.h>
#include "waypoint_navigation/srv/detail/get_way_points__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__ServiceMembers waypoint_navigation__srv__detail__get_way_points__rosidl_typesupport_introspection_c__GetWayPoints_service_members = {
  "waypoint_navigation__srv",  // service namespace
  "GetWayPoints",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // waypoint_navigation__srv__detail__get_way_points__rosidl_typesupport_introspection_c__GetWayPoints_Request_message_type_support_handle,
  NULL  // response message
  // waypoint_navigation__srv__detail__get_way_points__rosidl_typesupport_introspection_c__GetWayPoints_Response_message_type_support_handle
};

static rosidl_service_type_support_t waypoint_navigation__srv__detail__get_way_points__rosidl_typesupport_introspection_c__GetWayPoints_service_type_support_handle = {
  0,
  &waypoint_navigation__srv__detail__get_way_points__rosidl_typesupport_introspection_c__GetWayPoints_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, waypoint_navigation, srv, GetWayPoints)() {
  if (!waypoint_navigation__srv__detail__get_way_points__rosidl_typesupport_introspection_c__GetWayPoints_service_type_support_handle.typesupport_identifier) {
    waypoint_navigation__srv__detail__get_way_points__rosidl_typesupport_introspection_c__GetWayPoints_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)waypoint_navigation__srv__detail__get_way_points__rosidl_typesupport_introspection_c__GetWayPoints_service_type_support_handle.data;
  ...
  return &waypoint_navigation__srv__detail__get_way_points__rosidl_typesupport_introspection_c__GetWayPoints_service_type_support_handle;
}
