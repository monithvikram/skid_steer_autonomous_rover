...
#ifndef WAYPOINT_NAVIGATION__SRV__DETAIL__GET_WAY_POINTS__FUNCTIONS_H_
#define WAYPOINT_NAVIGATION__SRV__DETAIL__GET_WAY_POINTS__FUNCTIONS_H_
 ...
 * calls
 * waypoint_navigation__srv__GetWayPoints_Request__init().
...
/**
 * It calls
 * waypoint_navigation__srv__GetWayPoints_Request__fini()
 ...
 * waypoint_navigation__srv__GetWayPoints_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * waypoint_navigation__srv__GetWayPoints_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * waypoint_navigation__srv__GetWayPoints_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_waypoint_navigation
...
/**
 * It calls
 * waypoint_navigation__srv__GetWayPoints_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_waypoint_navigation
...
/**
 * It allocates the memory for the array and calls
 * waypoint_navigation__srv__GetWayPoints_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_waypoint_navigation
...
/**
 * It calls
 * waypoint_navigation__srv__GetWayPoints_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // WAYPOINT_NAVIGATION__SRV__DETAIL__GET_WAY_POINTS__FUNCTIONS_H_
